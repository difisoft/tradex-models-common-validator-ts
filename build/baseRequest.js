...
let baseRequestAjv = null;
function baseRequestValidator() {
    if (baseRequestAjv == null) {
        baseRequestAjv = new Ajv({ validateSchema: false }).compile(exports.baseRequestSchema);
    }
    return baseRequestAjv;
}
